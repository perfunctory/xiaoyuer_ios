...
-(void) addImageviewsForMainScrollWithImages: (NSArray *) images{
    ...
    for ( int i = 0; i < _imageViewArray.count + 1; i ++) {
        ...
        [tempImageView sd_setImageWithURL:[NSURL URLWithString:imageName] placeholderImage:ImageNamed(@"home_BG")];
       // tempImageView.image = ImageNamed(@"home_SY");
//        UIImage *imageTemp = [UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:imageName]]];// [UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:imageName]]];//[UIImage imageNamed:imageName];
