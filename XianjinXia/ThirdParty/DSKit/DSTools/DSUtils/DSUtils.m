...
//  DSDeveloperKit
//
//  Created by FengDongsheng on 12/8/6.
...
//    return strUUID;
    NSString * currentDeviceUUIDStr = [XJXKeychain passwordForService:@"com.innext.XianjinXia"account:@"uuid"];
    if (currentDeviceUUIDStr == nil || [currentDeviceUUIDStr isEqualToString:@""])
    {
        ...
        [XJXKeychain setPassword: currentDeviceUUIDStr forService:@"com.innext.XianjinXia"account:@"uuid"];
    }
