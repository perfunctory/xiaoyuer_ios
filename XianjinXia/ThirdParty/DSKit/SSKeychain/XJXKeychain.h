...
/**
 Error code specific to XJXKeychain that can be returned in NSError objects.
 For codes returned by the operating system, refer to SecBase.h for your
 platform.
 */
typedef NS_ENUM(OSStatus, XJXKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	XJXKeychainErrorBadArguments = -1001,
};

/** XJXKeychain error domain */
extern NSString *const kXJXKeychainErrorDomain;

/** Account name. */
extern NSString *const kXJXKeychainAccountKey;
 ...
 */
extern NSString *const kXJXKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kXJXKeychainClassKey;

/** Item description. */
extern NSString *const kXJXKeychainDescriptionKey;

/** Item label. */
extern NSString *const kXJXKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kXJXKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kXJXKeychainWhereKey;
...
/**
 ...
 XJXKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface XJXKeychain : NSObject
...
/**
 ...
 See the `NSString` constants declared in XJXKeychain.h for a list of keys that can be used when accessing the
...
//#import <XJXKeychain/XJXKeychainQuery.h>
