...
//    [self.manualButotn setTitle:@"转人工" forState:UIControlStateNormal];
    ...
    [self.manualButotn setTitleColor:Color_White forState:UIControlStateNormal];
...
//    [self.logoutButton setTitle:@"注销" forState:UIControlStateNormal];
    [self.logoutButton setTitle:NSLocalizedString(@"button.back", nil) forState:UIControlStateNormal];
    [self.logoutButton setTitleColor:Color_White forState:UIControlStateNormal];
...
//                    guestBookViewController.leaveMsg = scheduleDic[@"leavemsgTip"];
...
//    if (![_titleView.stateInfoLabel.text  isEqual: @"对方正在输入"]) {
...
//    _titleView.stateInfoLabel.text = @"对方正在输入";
