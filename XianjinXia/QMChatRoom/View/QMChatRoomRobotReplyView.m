...
//        self.describeLbl.text = @"多谢鼓励，我们再接再厉!";
        ...
        [self.helpBtn setSelected:NO];
//        self.describeLbl.text = @"感谢反馈，我们继续努力。";
        self.describeLbl.text = NSLocalizedString(@"title.thanks", nil);
    }else {
        [self.horizonalLine setHidden:YES];
        [self.describeLbl setHidden:YES];
...
//    [self.noHelpBtn setTitle:@"没帮助" forState:UIControlStateNormal];
    [self.noHelpBtn setTitle:NSLocalizedString(@"buton.nohelp", nil) forState:UIControlStateNormal];
